...
class Sequence:
    ...
    def __init__(self, token_ids: list[int], sampling_params = SamplingParams(), input_tensors = torch.Tensor()):
        ...
        self.cross_num_tokens = 1500
        self.encoder_tensors = input_tensors
        #
    ...
    # cross
    @property
    def num_cross_blocks(self):
        return (self.cross_num_tokens + self.block_size - 1) // self.block_size
    ...
    # cross
    @property
    def last_cross_block_num_tokens(self):
        return self.cross_num_tokens - (self.num_cross_blocks - 1) * self.block_size
    ...
    def __setstate__(self, state):
        ...
        if self.num_completion_tokens == 0:
            ...
            self.last_token = tokens_or_last
